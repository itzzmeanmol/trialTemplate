...
<h1>Hi, <b><?php echo htmlspecialchars($_SESSION["id"]); ?></b>. Welcome to our site.</h1>
    ...
    <form method="POST" action="save.php" enctype="multipart/form-data" id="form">
        ...
        <!-- fieldsets -->
        <fieldset>
            <h1>What type of templete you are looking for??</h1>
            ...
            <div class="row">
                ...
                <div class="column">
                    <div class="card">
                        ...
                        <input type="radio" value="1" name="template" checked> <span style="float: left; color: rgb(139, 134, 134);">Student</span>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="card">
                        ...
                        <input type="radio" value="2" name="template"> <span style="float: left; color: rgb(139, 134, 134);">Professional</span>
                    </div>
                </div>
            </div>
